...
class MediaCreatorMock: MediaCreator {
    ...
    var startHandler: ((Int) throws -> Void)?
    ...
    var startTimeHandler: ((CMTime) throws -> Void)?
    ...
    var finishHandler: ((@escaping () -> Void) -> Void)?
    ...
    var writeHandler: ((MTLTexture, Int) throws -> Void)?
    ...
    var writeTextureHandler: ((MTLTexture, CMTime) throws -> Void)?
    ...
    var writePcmHandler: ((AVAudioPCMBuffer, Int) throws -> Void)?
    ...
    var writePcmTimeHandler: ((AVAudioPCMBuffer, CMTime) throws -> Void)?
